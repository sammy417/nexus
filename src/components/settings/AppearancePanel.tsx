...
export default function AppearancePanel() {
  ...
  return (
    <section className="rounded-2xl bg-white p-6 shadow-sm dark:bg-card-dark">
      <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">화면 테마</p>
      <p className="mt-1 text-xs leading-relaxed text-gray-400 dark:text-gray-500">
        밝기 모드를 선택하세요. 어두운 곳에서는 눈이 편한 다크 모드를 권장합니다. &lsquo;시스템&rsquo;은
        기기의 다크 모드 설정을 자동으로 따릅니다.
      </p>
